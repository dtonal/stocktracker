...
public interface HistoricalPriceRepository extends JpaRepository<HistoricalPrice, String> {
     ...
     */
    List<HistoricalPrice> findByStockId(String stockId);

    /**
     * Findet alle historischen Preise für eine bestimmte Aktie in einem
     * Datumsbereich
     */
    ...
    /**
     * Findet einen spezifischen historischen Preis für eine Aktie an einem
     * bestimmten Datum
     */
